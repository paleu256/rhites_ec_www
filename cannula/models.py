...
class gbvTool(models.Model):
    ...
    fd1_5=models.CharField("1.5 Facility eliminates or reduces fees for GBV patients",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_6=models.CharField("1.6 Facility prioritizes patients who have experienced sexual assault to ensure they receive care and support as soon as possible",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_7=models.CharField("1.7 Facility ensures all patients have equal access to care, regardless of sex,marital status, age, disability, race, religion, and  ethnicity",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_8=models.CharField("2.1 Facility has visible IEC materials for patients (e.g., posters and/or pamphlets on what to do in case of GBV, GBV laws and rights, and available services) in high-traffic areas ",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_9=models.CharField("3.1 Facility offers GBV services in a location that is part of —or next to— a health facility ",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_10=models.CharField("3.2 Facility ensures that signs inside and outside the facility are discreet ",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_11=models.CharField("3.3 Facilitys rooms/areas where GBV counseling and clinical services are provided are private ",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_12=models.CharField("3.5 Facility has all essential infrastructure, furniture, equipment, supplies, documents, and commodities available ",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_13=models.CharField("3.6 Facility has a system in place to check on a quarterly basis whether medicines, vaccines, and tests are within validity/expiration date, and safely discard those that have expired",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_14=models.CharField("3.7 Facility integrates essential GBV supplies, commodities, vaccines, tests and equipment (DETAILS IN BOX 1) within the facility’s essential supply chain",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_15=models.CharField("3.8 Facility has not had a stock-out of essential GBV supplies, vaccines, tests or medicines (DETAILS IN BOX 1) in the past three months, and there is a system in place for emergency orders",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_16=models.CharField("4.1 Active case identification If patient presents with common signs and symptoms for IPV or SV (SEE SIGNS AND SYMPTOMS IN BOX 2), the provider asks about IPV or SV (based on suspicion of violence)",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_17=models.CharField("4.2 Facility has a standard process to ask about IPV or SV (e.g., job aid, algorithm, etc.) which aligns with national guidelines",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_18=models.CharField("4.3 Facilitys policy is to conduct routine enquiry about IPV or SV ONLY IF services meet all of the following WHO minimum requirements for routine enquiry",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_19=models.CharField("5.2 Provider brings up topic of GBV carefully by making some general statements about GBV before asking patient directly about her/his situation",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_20=models.CharField("5.3 Provider does not require patient to talk about her/his experience of IPV or SV if s/he does not want to",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_21=models.CharField("5.4 Provider explains that s/he will ask the patient detailed questions to assess his or her safety and to make sure s/he gets the right treatment and support ",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_22=models.CharField("5.5 Provider asks simple and direct questions about specific acts of violence to enquire about IPV or SV and documents responses",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_23=models.CharField("6.1 Provider  asks simple and direct questions to assess immediate danger to the patient’s life",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_24=models.CharField("6.2 If patient responds “yes” to 3 of the questions above concerning immediate danger, or if the patient requests shelter, the provider offers appropriate referrals to shelter or safe housing, or works with the patient to identify a safe place where s/he can go",max_length=4,choices=GbvQaTool_Choices,default=None)
...
class gbvTool2(models.Model):
    ...
    fd1_28=models.CharField("7.3 Provider follows national or facility guidelines for obtaining informed assent from children and adolescents if patient is under age of maturity",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_29=models.CharField("7.4 Provider never forces the patient, including children of any age, to undergo an examination against her/his will, unless the examination is necessary for medical treatment ",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_30=models.CharField("7.5 Provider makes it clear to the patient that s/he can decline any component of the examination or counseling session at any point, and seeks verbal consent at each stage of the examination",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_31=models.CharField("7.6 Provider respects the patient’s decision about whether to involve the police at all times, if in accordance with national law",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_32=models.CharField("7.7 If police involvement is legally mandated (e.g. for a minor), provider informs the patient or guardian about required procedures, patient rights, and possible outcomes of police involvement.as early in the discussion as possible",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_33=models.CharField("7.8 After the child’s safety has been secured and acute clinical care has been provided, if required by law, provider makes any mandated reports to authorities. This decision is guided by the least harmful course of action that takes into account the best interests of the child and his/her right to protection",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_34=models.CharField("8.1 Provider assesses and documents vital signs",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_35=models.CharField("8.2 Provider ensures patient is medically stabilized and treats serious injuries immediately ",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_36=models.CharField("8.3 Provider takes a detailed medical history, as appropriate, from the patient (or from guardian/trusted companion if patient is unable to give a history and has consented to a companion being present, or the patient is a minor) ",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_37=models.CharField("8.4 Provider manages genital and anal injuries appropriately (e.g., sutures deep vaginal, cervical, or anal lacerations or refers to higher-level facility if indicated, particularly in cases of female genital mutilation)",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_38=models.CharField("8.5 Provider manages minor injuries appropriately, after forensic evidence is collected (only if patient has given informed consent for collection of forensic evidence) (SEE STANDARD 19)",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_39=models.CharField("9.1 Provider demonstrates knowledge of empathetic and appropriate communication skills to use with all patients",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_40=models.CharField("10.1.1 Provider contacts a trained social worker or Family and child protection unit to be present throughout the examination and during any interaction with law enforcement",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_41=models.CharField("10.2 Provider offers compassionate, supportive counseling prior to history taking",max_length=4,choices=GbvQaTool_Choices,default=None)   
    fd1_42=models.CharField("10.3 If provider suspects home environment is abusive or dangerous, provider works to identify alternative shelter or appropriate course of action for child",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_43=models.CharField("10.4 For child patients, provider uses child-friendly communication techniques.",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_44=models.CharField("10.5 Provider permits child to have a trusted companion present during the exam, recognizing the companion may or may not be the caregiver or parent ",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_45=models.CharField("10.6 To avoid pain or serious injury, provider does not use a speculum to examine pre-pubertal girls, unless an internal vaginal injury or internal bleeding is suspected— in which case general anesthesia is administered prior to exam and a child-sized, small speculum is used",max_length=4,choices=GbvQaTool_Choices,default=None)
    fd1_46=models.CharField("10.7 Facility has child-appropriate dolls, toys or drawing supplies (paper, crayon/marker/pencil/paint) available ",max_length=4,choices=GbvQaTool_Choices,default=None)
