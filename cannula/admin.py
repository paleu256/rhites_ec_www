...
from .models import region,district,health_facility,health_subcounty,SourceDocument, OrgUnit, DataElement, DataValue, Category, CategoryCombo, ValidationRule, load_excel_to_datavalues, load_excel_to_validations
...
admin.site.register(health_subcounty)
